        ...
        <>
            ...
            <section className="list-product">
                <div className="product">
                    <a className="list-name" href="">iphone 15</a>
                    <a className="list-name" href="">iphone 14</a>
                    <a className="list-name" href="">iphone 13</a>
                    <a className="list-name" href="">iphone 12</a>
                </div>
            </section>
